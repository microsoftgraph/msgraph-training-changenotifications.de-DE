# <a name="using-change-notifications-and-track-changes-with-microsoft-graph"></a>Verwenden von Änderungsbenachrichtigungen und Nachverfolgen von Änderungen mit Microsoft Graph
